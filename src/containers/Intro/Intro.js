    ...
    return (
        <section className="intro">
            ...
            <div className="intro__container">
                ...
                <iframe src="https://www.youtube.com/embed/PZY-hB2C_Iw" frameborder="0" allow="accelerometer; gyroscope;" allowfullscreen className="no-border" title="Preschool Video"></iframe>
                </div>
                <div className="intro__content">
                    <p>Creative Wonder Early Learning Center provides a high standard of care, education and learning opportunities.
                    Children are able to explore a rich and <a href="index.html" >diverse range of activities</a> within a flexible, stimulating, inclusive
                    ...
                    <p>Children develop in a fun and relaxed environment. The involvement of parents in their child's
